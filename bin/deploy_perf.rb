...
$threads[:db001] = Thread.new { deploy_server "db001-perf-dfw", "BigCouch Node 1", "208.90.213.57", [ "perf", "rvm", "dfw", "dynect", "bigcouch" ], [ "iptables", "bigcouch::cluster_internal", "hosts", "rsyslog::client" ] }
sleep 5

$threads[:db002] = Thread.new { deploy_server "db002-perf-dfw", "BigCouch Node 2", "208.90.213.58", [ "perf", "rvm", "dfw", "dynect", "bigcouch" ], [ "iptables", "bigcouch::cluster_internal", "hosts", "rsyslog::client" ] }
sleep 5
$threads[:db003] = Thread.new { deploy_server "db003-perf-dfw", "BigCouch Node 3", "208.90.213.59", [ "perf", "rvm", "dfw", "dynect", "bigcouch" ], [ "iptables", "bigcouch::cluster_internal", "hosts", "rsyslog::client" ] }
sleep 5

$threads[:apps001] = Thread.new { deploy_server "apps001-perf-dfw", "App Server 1", "208.90.213.55", [ "perf", "rvm", "dfw", "dynect", "whistle-apps-rpm" ], [ "iptables", "hosts", "whistle::dth", "logrotate::opensip", "opensips", "haproxy::bigcouch_lb" ] }
sleep 5
$threads[:apps002] = Thread.new { deploy_server "apps002-perf-dfw", "App Server 2", "208.90.213.56", [ "perf", "rvm", "dfw", "dynect", "whistle-apps-rpm" ], [ "iptables", "hosts", "whistle::dth", "logrotate::opensip", "opensips", "haproxy::bigcouch_lb" ] }
sleep 5
$threads[:fs001] = Thread.new { deploy_server "fs001-perf-dfw", "FreeSWITCH 1", "208.90.213.60", [ "perf", "rvm", "dfw", "dynect", "whistle-fs" ], [ "hosts", "iptables" ] }
sleep 5
$threads[:fs002] = Thread.new { deploy_server "fs002-perf-dfw", "FreeSWITCH 2", "208.90.213.61", [ "perf", "rvm", "dfw", "dynect", "whistle-fs" ], [ "hosts", "iptables" ] }
sleep 5
